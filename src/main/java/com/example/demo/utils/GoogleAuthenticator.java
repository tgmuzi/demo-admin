 ...
 * 
 * @author: xiaobin
 * @version: 2018年3月31日 上午11:51:24
 */
public class GoogleAuthenticator {
	protected static Logger logger = LoggerFactory.getLogger(GoogleAuthenticator.class);
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
		...
		// String format =
		// "//www.google.com/chart?chs=200x200&cht=qr&chl=otpauth://totp/%s?secret=%s";
		String format = "//chart.googleapis.com/chart?cht=qr&chs=200x200&chl=otpauth://totp/%s?secret=%s";
